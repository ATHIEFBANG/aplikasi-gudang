            ...
            <div className="w-full max-w-4xl relative z-10 my-auto pt-12 sm:pt-0">
                            ...
                            <div className="relative z-10 w-full max-w-sm ml-auto my-auto py-2 pr-1 sm:pr-2">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-1">
                                        Masukkan email terdaftar kamu. Kami akan mengirimkan tautan untuk mereset password.
                                    </p>
                                </div>

                                {status && (
                                    <div className="mt-4 text-xs font-medium text-emerald-400 bg-emerald-950/60 p-3 rounded-xl border border-emerald-800/80 backdrop-blur-sm">
                                        {status}
                                    </div>
                                )}
                                ...
                                <div className="pt-4 border-t border-slate-800/80 mt-5">
                                    <p className="text-[11px] text-slate-400">
                                        Masih butuh bantuan? Hubungi <span className="font-semibold text-slate-200">Administrator Gudang</span>.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="relative mx-auto w-[108%] -ml-[4%] select-none pointer-events-none z-10">
                    <div className="h-4 sm:h-5 bg-slate-900 rounded-b-lg border-x border-b border-slate-800/90 shadow-[0_20px_50px_rgba(0,0,0,0.95)] relative flex justify-center items-center overflow-hidden">
                        ...
                        <div className="w-20 sm:w-28 h-1.5 sm:h-2 bg-slate-950 rounded-b-md border-x border-b border-slate-800/80 -mt-2 sm:-mt-2.5" />
                    </div>
                </div>
            </div>
        </div>
